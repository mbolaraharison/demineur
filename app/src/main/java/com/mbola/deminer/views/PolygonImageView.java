...
package com.mbola.deminer.views;
...
import com.mbola.deminer.shapes.PolygonShapeSpec;
...
public class PolygonImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public boolean isAreaClickable(MotionEvent event){
        ...
        if((mouseX <= (cx+rayon) && mouseX >= (cx-rayon)) && (mouseY <= (cy+rayon) && mouseY >= (cy-rayon))){
            return true;
        }
